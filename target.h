...
#ifndef _BACKENDS_FPP_TARGET_H_
#define _BACKENDS_FPP_TARGET_H_
...
class CTarget : public Target {
 public:
    ...
    void emitMain(Util::SourceCodeBuilder* builder,
                  cstring functionName) const override;
